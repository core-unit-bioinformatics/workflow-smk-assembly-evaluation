...
NCBI_FCS_ADAPTOR_SIF = pathlib.Path("NOT-SET.NCBI_FCS_ADAPTOR_SIF")
NCBI_FCS_ADAPTOR_SCRIPT = pathlib.Path("NOT-SET.NCBI_FCS_ADAPTOR_SCRIPT")
...
NCBI_FCS_GX_DB = pathlib.Path("NOT-SET.NCBI_FCS_GX_DB")
NCBI_FCS_GX_SIF = pathlib.Path("NOT-SET.NCBI_FCS_GX_SIF")
NCBI_FCS_GX_SCRIPT = pathlib.Path("NOT-SET.NCBI_FCS_GX_SCRIPT")
NCBI_FCS_GX_TAX_ID = 0
if RUN_NCBI_FCS_GX:
    NCBI_FCS_GX_DB = NCBI_FCS_ROOT_PATH.joinpath(
        NCBI_FCS_PARAMS["gx_db"]
    )
    assert NCBI_FCS_GX_DB.parent.is_dir()
